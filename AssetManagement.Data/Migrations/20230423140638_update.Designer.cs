...
namespace AssetManagement.Data.Migrations
{
    ...
    [Migration("20230423140638_update")]
            ...
            modelBuilder.Entity("AssetManagement.Data.Asset", b =>
                {
                    ...
                    b.HasIndex(new[] { "CategoryId" }, "IX_Asset_CategoryId");

                    b.HasIndex(new[] { "CreatorId" }, "IX_Asset_CreatorId");

                    b.HasIndex(new[] { "ServiceCycleId" }, "IX_Asset_ServiceCycleId");

                    b.HasIndex(new[] { "StationId" }, "IX_Asset_StationId");
            ...
            modelBuilder.Entity("AssetManagement.Data.AssetAttribute", b =>
                {
                    ...
                    b.HasIndex(new[] { "AssetId" }, "IX_AssetAttribute_AssetId");
            ...
            modelBuilder.Entity("AssetManagement.Data.Notification", b =>
                {
                    ...
                    b.HasIndex(new[] { "AssetId" }, "IX_Notification_AssetId");

                    b.ToTable("Notification", (string)null);
                });

            modelBuilder.Entity("AssetManagement.Data.Office", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AssetManagement.Data.Service", b =>
                {
                    ...
                    b.HasIndex(new[] { "AssetId" }, "IX_Service_AssetId");
            ...
            modelBuilder.Entity("AssetManagement.Data.Asset", b =>
                {
                    ...
                    b.HasOne("AssetManagement.Data.Office", "Office")
                        .WithMany("Assets")
